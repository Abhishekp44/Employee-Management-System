...
class EmployeeManagement(models.Model):
    ...
    DES = (('TL', 'Team Lead'),('Associate', 'Associate'),('Manager', 'Manager'),)
    REPORT_MGN = (('TL', 'Team Lead'),('Manager', 'Manager'),('Owner', 'Owner'))
...
class DepartmentManagement(models.Model):
    empid = models.ForeignKey(EmployeeManagement, on_delete=models.CASCADE)
...
class SalaryManagement(models.Model):
    emp = models.ForeignKey(EmployeeManagement, on_delete=models.CASCADE)
    dept = models.ForeignKey(DepartmentManagement, on_delete=models.CASCADE)
